 ...
 */
/**
 * Provide support for themeleaders
 */
    class Themeleader extends Siteaction
    {
/**
 *
        ...
        public function handle($context)
        {
            ...
            if($formd->haspost('submitbutton'))
            {
                ...
                else
                {
                    ...
                    $spvsr->student_id = $student_id;
                    $spvsr->supervisor_id = $supervisor;
                    R::store($spvsr);
                }
            }
            return 'themeleader.twig';
        }
    }
?>
